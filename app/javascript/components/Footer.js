...
class Footer extends React.Component {
 ...
 render() {
  ...
  <div style={{float: 'left', width: 400}}><ul className="faca-parte">
        <h3 style={{color: 'white'}} className="titulo-footer">Institucional</h3>
  ...
  <h3 style={{color: 'white'}} className="titulo-footer">Redes Sociais</h3>
  <a href="http://www.facebook.com/"><img src="/img/facebook-logo.png" /></a>
  <a href="http://www.instagram.com/"><img src="/img/instagram-logo.png" /></a>
</ul>
</div>
  <br style={{clear: 'left'}} />
</div>
...
<div className="copyright" style={{float:'right', marginRight: '1%'}}>
  <div className="left-foot"><img src="/img/logowhite.png" /></div>
